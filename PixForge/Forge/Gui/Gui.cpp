...
PF::FORGE::Gui::Gui(const std::string &path, Renderer* renderer)
  : renderer(renderer) {
  IMGUI_CHECKVERSION();
  ImGui::CreateContext();
...
uint16_t PF::FORGE::Gui::generateUnique(){
  uint16_t id = ui.size();
...
void PF::FORGE::Gui::dock(std::function<void()> func){
...
void PF::FORGE::Gui::addWindow(WindowType type) {
...
void PF::FORGE::WindowLogGui::render() {
...
void PF::FORGE::WindowObjectGui::render(){
